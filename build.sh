...
PROJECT_DIR="/home/rlp-email-service-api"         # Directory where the code is located
OUTPUT_DIR="/app/rlp-email-service-api"           # Build output directory
BINARY_NAME="rlp-email-service-api"               # Name of the generated binary file
